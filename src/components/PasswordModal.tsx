  ...
  return (
    ...
    >
      <div className="space-y-4">
        {/* Mensagem de uso pessoal */}
        <div className="rounded-lg border border-brand-400/30 bg-brand-400/8 px-4 py-3 text-sm text-brand-300">
          <p className="font-semibold text-mist-100 mb-1">Uso Pessoal</p>
          <p>
            Este sistema é destinado exclusivamente para{" "}
            <strong>uso pessoal</strong>. Ao continuar, você confirma que tem 
            autorização para acessar este ambiente.
          </p>
        </div>
